...
> **Status: feature-complete and device-verified.** 45 tools, a default-deny double gate,
...
[Releases page](https://github.com/SixOfFive/AndroidMCP/releases) and sideload it:

```bash
adb install -r androidmcp-release.apk
```
...
All default-OFF except `list_capabilities`. The 40 below need **no root**; five optional
